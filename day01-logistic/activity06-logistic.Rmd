...
1. Is this an observational study or an experiment?
  Explain.
  __Experimental study because, the researchers focus on establishing the cause and effect relationship between dependent and independent variables.__
...
ggplot(data = res, aes(x = id, y = .resid)) + 
geom_point() + 
geom_hline(yintercept = 0, color = "red") + 
labs(x = "id", 
     y = "Deviance residuals", 
